...
function buildCharts(sample) {
  ...
  d3.json("samples.json").then((data) => {
    ...
    // Create and assign variable for bubble chart
    ...
    // create variable to access the wfreq for a specified id
    var metadata = data.metadata;
    var metadataArray = metadata.filter(objID => objID.id == sample);
